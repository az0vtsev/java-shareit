...
public class Validator {
    ...
    public static void checkBookingExistence(int bookingId, BookingStorage storage) throws NotFoundException {
    ...
    public static void checkBookingIsApproved(Booking booking) throws UnsupportedBookingDataException {
    ...
    public static void checkItemBookingData(int itemId, int userId, ItemStorage storage)
            throws NotFoundException, UnsupportedBookingDataException {
    ...
    public static void checkUserBookingItem(int userId, int itemId, BookingStorage bookingStorage)
            throws NotValidAuthorCommentException {
